...
- 可在后台管理系统 → 系统设置 → 基本设置中配置以下信息：
  - **ICP备案号**：填写您的ICP备案号（如：京ICP备12345678号）
  - **公安备案号**：填写您的公安备案号（如：京公网安备11010802012345号）
  - **版权信息**：自定义版权信息（如：© 2023 漂流瓶 版权所有）
  - **站长邮箱**：填写站长联系邮箱
- 配置后，前台所有页面底部会自动显示这些信息
- 备案号会自动添加相应的链接，点击可跳转到备案查询页面
